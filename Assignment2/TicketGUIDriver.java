/**
 * This program provides a GUI through which you can enter speed violators
...
public class TicketGUIDriver extends Application{
   ...
   public void start(Stage stage)
   {
	   //labels
	     ...
	     //originally Work Zone
	     Label positionLabel = new Label("Within a School Zone?");
	     ...
	     //originally School Zone
	     Label schoolPositionLabel = new Label("Within a Work Zone?");
