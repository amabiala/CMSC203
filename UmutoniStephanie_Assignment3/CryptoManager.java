public class CryptoManager {
	...
	public static String encryptBellaso(String plainText, String bellasoStr) {
		...
		if(plainText.length()> bellasoStr.length()) {
			for(int i=0;i<plainText.length();i++) {
				temp=plainText.charAt(i)+bellasoStr.charAt(i%bellasoStr.length());
				while (temp>UPPER_BOUND) {
					temp-=RANGE;
				}
			...
			for(int i=0;i<plainText.length();i++) {
				temp=plainText.charAt(i)-bellasoStr.charAt(i);
	...
	public static String decryptBellaso(String encryptedText, String bellasoStr) {
		...
		if(encryptedText.length()> bellasoStr.length()) {
			for(int i=0,j=0;i<encryptedText.length();i++) {
				temp=encryptedText.charAt(i)-bellasoStr.charAt(i%bellasoStr.length());
				while (temp<LOWER_BOUND) {
					temp+=RANGE;
				}
				decrypted+=(char)temp;
			...
			for(int i=0;i<encryptedText.length();i++) {
				temp=encryptedText.charAt(i)-bellasoStr.charAt(i);
				while (temp<LOWER_BOUND) {
					temp+=RANGE;
				}
				decrypted+=(char)temp;
